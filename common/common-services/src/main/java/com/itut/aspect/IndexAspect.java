...
public class IndexAspect implements ApplicationContextAware {
    ...
    @After("@annotation(com.itut.annotation.DeleteIndex)")
    ...
    @AfterReturning(pointcut = "@annotation(com.itut.annotation.Indexed)", returning = "result")
